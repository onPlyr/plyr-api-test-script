...
async function nftBalance(plyrId, chainId) {
    ...
    try {
        let ret = await axios.get(
            apiEndpoint + "/api/game/nft/balance?plyrId=" + plyrId + "&chainId=" + chainId , // you can filter by nft address (with comma as separator) and gameId too
            {
                headers: {
                    apikey: apiKey,
                    signature: hmac,
...
async function nftList(plyrId, chainId) {
    ...
    try {
        let ret = await axios.get(
            apiEndpoint + "/api/game/nft/list?plyrId=" + plyrId + "&chainId=" + chainId, // you can filter by nft address (with comma as separator) and gameId too
            {
                headers: {
                    apikey: apiKey,
                    signature: hmac,
