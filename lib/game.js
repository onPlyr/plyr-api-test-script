...
async function getGameAllowance(plyrId, gameId, tokenName) {
    ...
    try {
        let ret = await axios.get(
            apiEndpoint + "/api/game/allowance?plyrId="+plyrId+"&gameId="+gameId+"&tokenName="+tokenName,
            {
                headers: {
                    apikey: apiKey,
                    signature: hmac,
...
module.exports = { createGameRoom, joinGameRoom, leaveGameRoom, approveGameToken, payGameRoom, earnGameRoom, endGameRoom, getGameAllowance };
