...
async function payGameRoom(roomId, sessionJwt, tokenName, amount) {
    ...
    let body = {
        ...
        tokens: [tokenName], // Can add more token like ['token1', 'token2', 'token3']
...
async function earnGameRoom(roomId, plyrId, tokenName, amount) {
    ...
    let body = {
        roomId: roomId,
        plyrIds: [plyrId], // Can add more plyrIds like [plyrId1, plyrId2, plyrId3]
        tokens: [tokenName], // Can add more token like ['token1', 'token2', 'token3']
        amounts: [amount], // Can add more amount like [100, 200, 300]
    }
...
module.exports = { createGameRoom, joinGameRoom, isJoinedGameRoom, leaveGameRoom, approveGameToken, payGameRoom, earnGameRoom,  endGameRoom, getGameAllowance, revokeApproval, joinPay, earnLeave, createJoinPay, earnLeaveEnd };
